    ...
    public function datatables()
    {
         ...
         return DataTables::of($datas)
                            ->addColumn('action', function(BlogCategory $data) {
                                ...
                                <a href="' . route('admin-cblog-edit',$data->id) . '" class="btn btn-outline btn-sm blue""> <i class="fa fa-edit"></i>Edit</a>
                                <a data-href="'.route('admin-cblog-delete',$data->id).'" class="btn btn-outline delete-data  btn-sm red" data-toggle="confirmation" data-placement="top" data-id="'.$data->id.'" >
