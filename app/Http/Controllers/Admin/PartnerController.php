    ...
    public function datatables()
    {
         ...
         return DataTables::of($datas)
                            ->editColumn('photo', function(Partner $data) {
                                ...
                                return '<img  style="width:200px;" src="' . $photo . '" alt="Image">';
                            })
                            ->addColumn('action', function(Partner $data) {
                                return '<div class="action-list">
                                <a href="' . route('admin-partner-edit',$data->id) . '" class="btn btn-outline btn-sm blue""> <i class="fa fa-edit"></i>Edit</a>
                                <a data-href="'.route('admin-partner-delete',$data->id).'" class="btn btn-outline delete-data  btn-sm red" data-toggle="confirmation" data-placement="top" data-id="'.$data->id.'" >
