                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject  sbold uppercase">Recipe Replies</span>

                                    </div>
                                    <div class="actions">
                                                <div class="btn-group">
                                                  <a class="btn default disabled" id="c-rp-ttl" style="margin-right: 10px;" data-toggle="modal" href="#basic" >Bulk Edit <span class="ed-rc-ttl">0</span> Replies</a>
                                                 </div>               
                                     </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Bulk Edit <span class="ed-rc-ttl"></span> Reply </h4>
                </div>
                <form id="bulk-edit-form" action="{{route('admin-recipe-reply-bulkedit')}}" method="post">
                  @csrf
                  <div class="modal-body"> <b>Select an action to perform:</b>
                      ...
                      <div class="mt-radio-list">
                          ...
                          <label class="mt-radio mt-radio-outline">
                              <input type="radio" class="bulkEditRadio" name="bulkEditRadios" id="optionsRadios27" value="5" > Delete Reply
                              <span></span>
                          </label> 
...
<script type="text/javascript">
        var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-recipe-reply-datatables') }}',
               columns: [
