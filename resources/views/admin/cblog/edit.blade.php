    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">Edit Blog Category</span>
        ...
        <div class="portlet-body form">
            ...
            <form id="geniusform" action="{{route('admin-cblog-update',$data->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            {{csrf_field()}}
