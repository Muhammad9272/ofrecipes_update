                ...
                <div class="form-body">
                        ...
                        <div class="col-md-9">
                            <div class="mt-checkbox-inline">
                                <label class="mt-checkbox mt-checkbox-outline">
                                    <input type="checkbox" value="1" class="seocheck" {{$data->seo_check==1?'checked':''}} name="seo_check" >{{ __('Allow Page SEO') }}
                                    <span></span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="{{$data->seo_check==1?'':'seofields'}}" id="seofield">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 d-inline-flex">
                                <input  type="text" class="form-control" data-role="tagsinput" name="meta_tag" value="{{$data->meta_tag}}" >  
