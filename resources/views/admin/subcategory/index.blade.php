                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject  sbold uppercase">SubCategories</span>
                                        
                                    </div>
                                    <div class="actions">
                                                <div class="btn-group">
                                                  <a class="btn default disabled" id="c-rp-ttl" style="margin-right: 10px;" data-toggle="modal" href="#basic" >Bulk Edit <span class="ed-rc-ttl">0</span> Subcategories</a>
                                                 </div>

                                                <div class="btn-group">
                                                    <a id="sample_editable_1_new" class="btn sbold green" href="{{route('admin-subcat-create')}}"> Add New
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Bulk Edit <span class="ed-rc-ttl"></span> Subcategory </h4>
                </div>
                <form id="bulk-edit-form" action="{{route('admin-subcat-bulkedit')}}" method="post">
                  @csrf
                  <div class="modal-body"> <b>Select an action to perform:</b>
                      ...
                      <div class="mt-radio-list">
                          ...
                          {{-- <label class="mt-radio mt-radio-outline">
                              <input type="radio" class="bulkEditRadio" name="bulkEditRadios" id="optionsRadios27" value="5" > Delete Subcategory
                              <span></span>
                          </label> --}} 
